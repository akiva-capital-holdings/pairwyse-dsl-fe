...
const columns: ColumnsType<MockType> = [
    ...
    },
    {
      ...
      dataIndex: 'txID',
      key: 'txID',
      render: txID => <div className='status'>
          <div style={{textOverflow: 'ellipsis', overflow: 'hiden' }}>
              {txID}
         </div> 
    ...
    },
    {
      ...
      render:  agreementAddress => <div className='status'>
      <div style={{textOverflow: 'ellipsis', overflow: 'hiden' }}>
          {agreementAddress}
     </div> 
    ...
    },
    {
      ...
      render: txOriginator => <div className='status'>
      <div style={{textOverflow: 'ellipsis', overflow: 'hiden' }}>
          {txOriginator}
     </div> 
...
const Transaction = () => {
 ...
 return <Layout style={{ minHeight: '700px' }}>
     ...
     <div className='header'>
        ...
        <Content style={{ display: 'block', margin: '24px 16px 0' }}>
          ...
          >
          {transactions?.length ? <div className='userList'>
          <Table
           dataSource={mock}
           columns={columns}
           rowKey='id'
